    ...
    if packet.dst.is_multicast:
      ...
      if packet.dst not in self.macToPort: # 4
        ...
        if mac_src[-1] == '1' or mac_src[-1] == '2':
          #Capturar puerto de entrada del switch y redirigirlo
          #Grupo 26 => 2+6=8 => sentido anti-horario
          if puerto == 2 or puerto == 4:
            #Sale por el puerto del switch antihorario
        ...
        #Host 7 y 8
        if mac_src[-1] == '7' or mac_src[-1] == '8':
          if puerto == 14 or puerto == 16:
            print("Puerto de salida: ", 23)
            msg.actions.append(of.ofp_action_output(port = 23))

        #Redirigir el flujo de llegada a traves de los switch
        #Switch 2
        if puerto == 18:
          #Si el mensaje va al host 3, debe ir por el puerto 6
          if mac_dst[-1] == '3':
            print("Puerto de salida: ", 6)
            msg.actions.append(of.ofp_action_output(port = 6))

          #Si el mensaje va al host 4, debe ir por el puerto 8
          elif mac_dst[-1] == '4':
            print("Puerto de salida: ", 8)
            msg.actions.append(of.ofp_action_output(port = 8))

          #En otros casos, sigue por el switch en sentido anti-horario
          else:
            print("Puerto de salida: ", 19)
            msg.actions.append(of.ofp_action_output(port = 19))
        ...
        #Switch 3
        if puerto == 20:
          #Si el mensaje va al host 5, debe ir por el puerto 10
          if mac_dst[-1] == '5':
            print("Puerto de salida: ", 10)
            msg.actions.append(of.ofp_action_output(port = 10))

          #Si el mensaje va al host 6, debe ir por el puerto 12
          elif mac_dst[-1] == '6':
        ...
        #Switch 4
        if puerto == 22:
          #Si el mensaje va al host 7, debe ir por el puerto 14
          if mac_dst[-1] == '7':
            print("Puerto de salida: ", 14)
            msg.actions.append(of.ofp_action_output(port = 14))

          #Si el mensaje va al host 8, debe ir por el puerto 16
          elif mac_dst[-1] == '8':
            print("Puerto de salida: ", 16)
        ...
        #Switch 1
        if puerto == 24:
          #Si el mensaje va al host 1, debe ir por el puerto 2
          if mac_dst[-1] == '1':
            print("Puerto de salida: ", 2)
            msg.actions.append(of.ofp_action_output(port = 2))

          #Si el mensaje va al host 2, debe ir por el puerto 4
          elif mac_dst[-1] == '2':
